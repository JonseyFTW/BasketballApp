import { PlayEffectiveness, DefenseType, GameSituation } from '@prisma/client'
...
export const DEFENSE_TYPE_INFO: Record<DefenseType, DefenseTypeInfo> = {
  MAN_TO_MAN: {
    type: DefenseType.MAN_TO_MAN,
    name: 'Man-to-Man',
  ...
  SWITCHING_MAN: {
    type: DefenseType.SWITCHING_MAN,
    name: 'Switching Man',
  ...
  HELP_AND_RECOVER: {
    type: DefenseType.HELP_AND_RECOVER,
    name: 'Help & Recover',
  ...
  DENIAL_DEFENSE: {
    type: DefenseType.DENIAL_DEFENSE,
    name: 'Denial Defense',
  ...
  FULL_COURT_PRESS: {
    type: DefenseType.FULL_COURT_PRESS,
  ...
  HALF_COURT_PRESS: {
    type: DefenseType.HALF_COURT_PRESS,
  ...
  DIAMOND_PRESS: {
    type: DefenseType.DIAMOND_PRESS,
    name: 'Diamond Press',
  ...
  TRIANGLE_AND_TWO: {
    type: DefenseType.TRIANGLE_AND_TWO,
  ...
  GET_BACK_DEFENSE: {
    type: DefenseType.GET_BACK_DEFENSE,
  ...
  SLOW_BREAK_DEFENSE: {
    type: DefenseType.SLOW_BREAK_DEFENSE,
...
export const GAME_SITUATION_INFO: Record<GameSituation, GameSituationInfo> = {
  GENERAL: {
    situation: GameSituation.GENERAL,
  ...
  END_GAME: {
    situation: GameSituation.END_GAME,
    name: 'End Game',
  ...
  LAST_SHOT: {
    situation: GameSituation.LAST_SHOT,
    name: 'Last Shot',
  ...
  FOUL_SITUATION: {
    situation: GameSituation.FOUL_SITUATION,
    name: 'Foul Situation',
  ...
  AFTER_TURNOVER: {
    situation: GameSituation.AFTER_TURNOVER,
    name: 'After Turnover',
